...
!function(e) {
    ...
    function c() {
        t.load(function(e) {
            ...
            t=document.getElementById("match");
            t.innerText += e.data.matchTags
            t=document.getElementById("title");
            t.innerText += e.data.origin.title+"\n"
            t.innerText += e.data.origin.dynasty+"  "
            t.innerText += e.data.origin.author
            t=document.getElementById("content");
            for (var o = 0; o < e.data.origin.content.length; o++)
                t.innerText += e.data.origin.content[o]
            t=document.getElementById("translate");
            if (0!=t.e.data.origin.content.translate)
                t.innerText += e.data.origin.content.translate
        })
    }
    function r(e, n) {
